...
data Trade =
  Trade
    ...
    , initialMarginRequired :: AccountUnits                -- ^ The margin required at the time the Trade was created. Note this is
    ...
    , averageClosePrice     :: Maybe PriceValue            -- ^ The average closing price of the Trade. Only present if the Trade has been
    ...
    , closeTime             :: Maybe DateTime              -- ^ The date/time when the Trade was fully closed. Only provided for Trades whose state is
                                                           -- CLOSED.
    ...
    , stopLossOrder         :: Maybe StopLossOrder         -- ^ Full representation of the Trade’s Stop Loss Order only provided if such an
                                                           -- Order exists.
    , trailingStopLossOrder :: Maybe TrailingStopLossOrder -- ^ Full representation of the Trade’s Trailing Stop Loss Order
